...
export default function IntegrationsSection() {
    return (
        // Changed the main section to dark:bg-black for consistency
        <section className='dark:bg-black'> 
            {/* The main background div is now also set to dark:bg-black */}
            <div className="bg-muted dark:bg-black py-24 md:py-32"> 
                    ...
                    <div className="relative mx-auto flex max-w-sm items-center justify-between">
                        ...
                        <div className="mx-auto my-2 flex w-fit justify-center gap-2">
                            <div className="bg-muted relative z-20 rounded-2xl border p-1">
                                <IntegrationCard
                                    className="shadow-black-950/10 dark:bg-black size-16 border-black/25 shadow-xl dark:border-white/25 dark:shadow-white/10"
                                    isCenter={true}>
                                    <LogoIcon />
                                </IntegrationCard>
                            </div>
...
const IntegrationCard = ({ children, className, position, isCenter = false }: { children: React.ReactNode; className?: string; position?: 'left-top' | 'left-middle' | 'left-bottom' | 'right-top' | 'right-middle' | 'right-bottom'; isCenter?: boolean }) => {
    return (
        // IntegrationCard's dark mode background is kept as transparent or background, 
        // but the center card below has been updated to dark:bg-black as well.
